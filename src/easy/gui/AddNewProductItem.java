...
public class AddNewProductItem extends JDialog {
	...
	private ProductSearchWindow productsearch;
	...
	public AddNewProductItem(ProductDAO productdao, ProductSearchWindow productsearch, Product previousProduct,
			boolean updateMode) {
		this();
	...
	public AddNewProductItem(ProductDAO productdao, ProductSearchWindow productsearch) {
